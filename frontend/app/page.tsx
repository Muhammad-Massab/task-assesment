...
import { GET_TASKS, CREATE_TASK, UPDATE_TASK, DELETE_TASK } from "@/lib/graphql/queries"
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your tasks efficiently with GraphQL</p>
        </div>
              ...
              <CardContent>
                {tasks.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Separator */}
                    {pendingTasks.length > 0 && completedTasks.length > 0 && <Separator className="my-6" />}
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-start space-x-3 flex-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            {task.description && (
              <p className={`mt-1 text-sm ${task.completed ? "text-green-600 line-through" : "text-gray-600"}`}>
                {task.description}
              </p>
            )}
